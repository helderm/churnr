...
\section{Churn Prediction Models}
...
* Feature selection (check Lu2014) 

* How are the experiments performed? (cross validation, grid search, time window)

* How is the unbalanced class problem tackled?

* How is the user behaviour on Spotify?
