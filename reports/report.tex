...
\begin{definition}
\label{def:churn}
A user is defined to have \emph{churned} if he is active during the activity window and inactive during the prediction window. 
\end{definition}
...
\begin{equation}
\text{SPTD}_{t_0 \rightarrow t_\alpha} = [\mathbf{X}_{t_0 \rightarrow t_\alpha}, \mathbf{y}]
\end{equation}
...
\begin{figure}[h]
    \centering
    \includegraphics[width=0.9\textwidth,keepaspectratio]{figures/roc_example.pdf}
...
\begin{figure}[h]
    \centering
    \includegraphics[width=0.9\textwidth,keepaspectratio]{figures/prc_example.pdf}
...
\Todo{Will I do statistical significance? If so, how?}
...
\item Unless explicitly stated, the plots will show the metrics for the churned class, which is the focus of this project.
\end{itemize}
...
\midrule
\multirow{2}{*}{LSTM} & Retained &  \textbf{0.901823} &  \textbf{0.994568} &  \textbf{0.992342} &  \textbf{0.826438} \\
     & Churned &  \textbf{0.173997} &  0.204015 &   \textbf{0.098445} &  \textbf{0.748219} \\
\cline{1-6}
\multirow{2}{*}{Logistic Regression} & Retained &  0.831038 &  0.992812 &   0.991091 &  0.715492 \\
     & Churned &  0.114972 &  0.105123 &   0.062285 &  0.746072 \\
\cline{1-6}
\multirow{2}{*}{Random Forest} & Retained &  0.897689 &  0.994356 &   0.991901 &  0.819821 \\
     & Churned &  0.166283 &  \textbf{0.204470} &   0.093734 &  0.735728 \\
\bottomrule
\end{tabular}
...
\begin{figure}
    \centering
    \includegraphics[width=0.9\textwidth,keepaspectratio]{figures/prc_temporal_static.pdf}
    \caption{Precision-Recall curves for the LSTM and baseline models}
    \label{fig:prc_temporal_static}
\end{figure}

The results for this experiment shows that random forest has the best overall performance of all evaluated models for almost all metrics in \autoref{tab:temporal_static}. This follows the results observed during the pilot study of this project. The intuition behind this is that random forests can more easily learn the correlations between the data and the binary label given that proper features are engineered.

\begin{figure}
    \centering
    \includegraphics[width=0.9\textwidth,keepaspectratio]{figures/cfm_temporal_static.pdf}
    \caption{Normalized confusion matrices for the LSTM and baseline models}
...
Our experiment involved increasing the size of the observation window by 7 days while keeping the size of the prediction window constant in 30 days, the resulting scores can be seen in \autoref{fig:line_obs_window} and \autoref{fig:line_obs_window_ret}. 

\begin{figure}
    \centering
    \includegraphics[width=0.9\textwidth,keepaspectratio]{figures/line_obs_window.pdf}
...
\begin{figure}
    \centering
    \includegraphics[width=0.9\textwidth,keepaspectratio]{figures/line_obs_window_retained.pdf}
...
The result of this experiment can be seen in\autoref{fig:line_pred_window}. 

\begin{figure}
    \centering
    \includegraphics[width=0.9\textwidth,keepaspectratio]{figures/line_pred_window.pdf}
...
\begin{figure}
    \centering
    \includegraphics[width=0.9\textwidth,keepaspectratio]{figures/line_pred_window_retained.pdf}
    \caption{F1-scores for the retained class for different prediction window sizes and models}
    \label{fig:line_pred_window}
\end{figure}

\Todo{Reason about the pred window experiment}
...
\begin{figure}
    \centering
    \includegraphics[width=0.9\textwidth,keepaspectratio]{figures/line_class_balance.pdf}
...
\begin{figure}
    \centering
    \includegraphics[width=0.9\textwidth,keepaspectratio]{figures/line_class_balance_retained.pdf}
...
\toprule
     &          &  F1-Score &    PR AUC &  Precision &    Recall \\
\midrule
\multirow{2}{*}{LSTM} & Retained &  0.872797 &  0.992778 &   0.991944 &  0.779202 \\
     & Churned &  0.143338 &  0.152913 &   0.079239 &  0.750171 \\
\cline{1-6}
\multirow{2}{*}{Random Forest} & Retained &  0.883207 &  0.992759 &   0.991383 &  0.796315 \\
...
\begin{figure}
    \centering
    \includegraphics[width=0.9\textwidth,keepaspectratio]{figures/prc_obs_window.pdf}
    \caption{Precision-recall curves of the churned class for the observation window experiment. The models are LSTM, logistic regression and random forest, respectively}
    \label{fig:prc_obs_window}
\end{figure}

\begin{figure}
    \centering
    \includegraphics[width=0.9\textwidth,keepaspectratio]{figures/prc_pred_window.pdf}
    \caption{Precision-recall curves of the churned class for the prediction window experiment. The models are LSTM, logistic regression and random forest, respectively}
    \label{fig:prc_pred_window}
\end{figure}

\begin{figure}
    \centering
    \includegraphics[width=0.9\textwidth,keepaspectratio]{figures/prc_class_balance.pdf}
    \caption{Precision-recall curves of the churned class for the class balance experiment. The models are LSTM and random forest, respectively}
...
\begin{figure}[h]
    \centering
    \includegraphics[width=0.9\textwidth,keepaspectratio]{figures/roc_temporal_static.pdf}
    \caption{ROC curves for the LSTM vs. baseline models experiment}
    \label{fig:roc_temporal_static}
\end{figure}

\begin{figure}[h]
    \centering
    \includegraphics[width=0.9\textwidth,keepaspectratio]{figures/roc_obs_window.pdf}
...
\begin{figure}[h]
    \centering
    \includegraphics[width=0.9\textwidth,keepaspectratio]{figures/roc_pred_window.pdf}
...
\begin{figure}[h]
    \centering
    \includegraphics[width=0.9\textwidth,keepaspectratio]{figures/roc_class_balance.pdf}
...
\toprule
     &     &          &  F1-Score &    PR AUC &  Precision &    Recall \\
\midrule
\multirow{18}{*}{LSTM} & \multirow{2}{*}{10\%} & Retained &  \textit{0.961646} &  0.991275 &   0.984150 &  \textit{0.940148} \\
     &     & Churned &  \textit{0.202574} &  \textit{0.090036} &   \textit{0.137299} &  0.386163 \\
\cline{2-7}
     & \multirow{2}{*}{15\%} & Retained &  0.946061 &  0.991598 &   0.985619 &  0.909556 \\
     &     & Churned &  0.180157 &  0.077199 &   0.111897 &  0.461973 \\
\cline{2-7}
     & \multirow{2}{*}{20\%} & Retained &  0.919837 &  0.991991 &   0.988625 &  0.859998 \\
     &     & Churned &  0.164649 &  0.073727 &   0.095445 &  0.598871 \\
\cline{2-7}
     & \multirow{2}{*}{25\%} & Retained &  0.918358 &  0.992326 &   0.989153 &  0.857021 \\
     &     & Churned &  0.166948 &  0.076928 &   0.096486 &  0.618989 \\
\cline{2-7}
     & \multirow{2}{*}{30\%} & Retained &  0.911930 &  0.992033 &   0.988888 &  0.846085 \\
     &     & Churned &  0.156494 &  0.074946 &   0.089663 &  0.614573 \\
\cline{2-7}
     & \multirow{2}{*}{35\%} & Retained &  0.898646 &  0.991438 &   0.989102 &  0.823349 \\
     &     & Churned &  0.143794 &  0.070388 &   0.081122 &  0.632237 \\
\cline{2-7}
     & \multirow{2}{*}{40\%} & Retained &  0.874766 &  0.992236 &   0.990585 &  0.783195 \\
     &     & Churned &  0.133156 &  0.074518 &   0.073595 &  0.698234 \\
\cline{2-7}
     & \multirow{2}{*}{45\%} & Retained &  0.863309 &  0.991402 &   0.991214 &  0.764641 \\
     &     & Churned &  0.128737 &  0.060313 &   0.070638 &  0.725221 \\
\cline{2-7}
     & \multirow{2}{*}{50\%} & Retained &  0.839230 & \textit{ 0.992415} &   \textbf{0.992118} &  0.727171 \\
     &   & Churned &  0.123085 &  0.068765 &   0.066874 &  \textbf{0.771933} \\
\cline{1-7}
\cline{2-7}
\multirow{18}{*}{Random Forest} & \multirow{2}{*}{10\%} & Retained &  \textbf{0.981921} &  0.993655 &   0.983035 &  \textbf{0.980810} \\
     &     & Churned &  \textbf{0.300023} &  0.203894 &   \textbf{0.287416} &  0.313788 \\
\cline{2-7}
     & \multirow{2}{*}{15\%} & Retained &  0.974738 &  0.993544 &   0.985423 &  0.964282 \\
     &     & Churned &  0.293922 &  0.204665 &   0.225561 &  0.421737 \\
\cline{2-7}
     & \multirow{2}{*}{20\%} & Retained &  0.961760 &  0.993784 &   0.987977 &  0.936898 \\
     &     & Churned &  0.262594 &  0.209803 &   0.173706 &  0.537782 \\
\cline{2-7}
     & \multirow{2}{*}{25\%} & Retained &  0.961340 &  0.993670 &   0.988060 &  0.936027 \\
     &     & Churned &  0.261896 &  \textbf{0.212639} &   0.172719 &  0.541462 \\
\cline{2-7}
...
\cline{2-7}
     & \multirow{2}{*}{50\%} & Retained &  0.897189 &  \textbf{0.994240} &   \textit{0.991878} &  0.819002 \\
     &   & Churned &  0.165577 &  0.199575 &   0.093293 &  \textit{0.735240} \\
\bottomrule
\end{tabular}
...
\toprule
     &   &          &  F1-Score &    PR AUC &  Precision &    Recall \\
\midrule
\multirow{8}{*}{LSTM} & \multirow{2}{*}{7} & Retained &  0.823630 &  0.974100 &   0.971157 &  0.715013 \\
     &   & Churned &  \textit{0.272094} &  \textit{0.150116} &   \textit{0.167242} &  0.729376 \\
\cline{2-7}
     & \multirow{2}{*}{14} & Retained &  0.848669 &  0.987558 &   0.986669 &  0.744534 \\
     &   & Churned &  0.185941 &  0.099012 &   0.106108 &  0.750910 \\
\cline{2-7}
     & \multirow{2}{*}{21} & Retained &  0.845348 &  0.989559 &   0.990381 &  0.737367 \\
     &   & Churned &  0.142604 &  0.060440 &   0.078705 &  0.758035 \\
\cline{2-7}
     & \multirow{2}{*}{28} & Retained &  \textit{0.861970} &  \textit{0.992292} &   \textit{0.992303} &  \textit{0.761899} \\
     &   & Churned &  0.133607 &  0.075458 &   0.073233 &  \textit{0.760976} \\
\cline{1-7}
\cline{2-7}
...
\multirow{8}{*}{Random Forest} & \multirow{2}{*}{7} & Retained &  0.859076 &  0.984100 &   0.979099 &  0.765265 \\
     &   & Churned &  \textbf{0.331079} &  \textbf{0.333607} &   \textbf{0.209295} &  \textbf{0.791815} \\
\cline{2-7}
...
\cline{2-7}
     & \multirow{2}{*}{28} & Retained &  \textbf{0.907344} &  \textbf{0.994559} &   \textbf{0.992572} &  \textbf{0.835596} \\
...
\toprule
     &   &          &  F1-Score &    PR AUC &  Precision &    Recall \\
\midrule
\multirow{16}{*}{LSTM} & \multirow{2}{*}{7} & Retained &  0.759781 &  0.991025 &   0.992226 &  0.615572 \\
     &   & Churned &  0.095322 &  0.053770 &   0.050642 &  0.809603 \\
\cline{2-7}
     & \multirow{2}{*}{14} & Retained &  0.851632 &  0.992178 &   0.991327 &  0.746445 \\
     &   & Churned &  0.126301 &  0.071872 &   0.069023 &  0.742168 \\
\cline{2-7}
     & \multirow{2}{*}{21} & Retained &  \textit{0.867829} &  \textit{0.992460} &   0.991078 &  \textit{0.771844} \\
     &   & Churned &  \textit{0.135221} &  0.070760 &   \textit{0.074557} &  0.725676 \\
\cline{2-7}
     & \multirow{2}{*}{28} & Retained &  0.754988 &  0.991924 &   \textbf{0.993143} &  0.608960 \\
     &   & Churned &  0.096572 &  0.067951 &   0.051253 &  \textbf{0.834000} \\
\cline{2-7}
     & \multirow{2}{*}{35} & Retained &  0.840498 &  0.992837 &   0.992663 &  0.728783 \\
     &   & Churned &  0.126028 &  \textit{0.078335} &   0.068496 &  0.787352 \\
\cline{2-7}
     & \multirow{2}{*}{42} & Retained &  0.789003 &  0.991724 &   0.992310 &  0.654839 \\
     &   & Churned &  0.103672 &  0.069907 &   0.055429 &  0.799649 \\
\cline{2-7}
     & \multirow{2}{*}{49} & Retained &  0.838852 &  0.992317 &   0.992239 &  0.726539 \\
     &   & Churned &  0.123394 &  0.074572 &   0.067029 &  0.775642 \\
\cline{2-7}
     & \multirow{2}{*}{56} & Retained &  0.839230 &  0.992415 &   0.992118 &  0.727171 \\
     &   & Churned &  0.123085 &  0.068765 &   0.066874 &  0.771933 \\
\cline{1-7}
\cline{2-7}
\multirow{16}{*}{Logistic Regression} & \multirow{2}{*}{7} & Retained &  0.813669 &  0.991255 &   0.988039 &  0.691613 \\
     &   & Churned &  0.096712 &  0.076252 &   0.052121 &  0.669464 \\
\cline{2-7}
     & \multirow{2}{*}{14} & Retained &  0.825072 &  0.991869 &   0.989110 &  0.707703 \\
     &   & Churned &  0.104654 &  0.088905 &   0.056605 &  0.692398 \\
\cline{2-7}
     & \multirow{2}{*}{21} & Retained &  0.826448 &  0.992184 &   0.989865 &  0.709342 \\
     &   & Churned &  0.108169 &  0.096096 &   0.058522 &  0.713282 \\
\cline{2-7}
     & \multirow{2}{*}{28} & Retained &  0.829265 &  0.992497 &   0.990268 &  0.713294 \\
...
\cline{2-7}
     & \multirow{2}{*}{42} & Retained &  0.829915 &  0.992647 &   0.990726 &  0.714018 \\
     &   & Churned &  0.113018 &  0.101979 &   0.061208 &  0.736118 \\
\cline{2-7}
     & \multirow{2}{*}{49} & Retained &  \textit{0.834664} &  0.992744 &   0.990785 &  \textit{0.721046} \\
     &   & Churned &  \textit{0.115348} &  \textit{0.104808} &   \textit{0.062583} &  0.735240 \\
\cline{2-7}
     & \multirow{2}{*}{56} & Retained &  0.830921 &  \textit{0.992801} &   \textit{0.991129} &  0.715299 \\
     &   & Churned &  0.115075 &  0.103801 &   0.062337 &  \textit{0.747243} \\
\cline{1-7}
\cline{2-7}
\multirow{16}{*}{Random Forest} & \multirow{2}{*}{7} & Retained &  0.876152 &  0.993256 &   0.991183 &  0.785044 \\
     &   & Churned &  0.141873 &  0.140149 &   0.078638 &  0.724310 \\
\cline{2-7}
     & \multirow{2}{*}{14} & Retained &  0.890559 &  0.993822 &   0.991668 &  0.808161 \\
     &   & Churned &  0.157307 &  0.170996 &   0.088123 &  0.731922 \\
\cline{2-7}
     & \multirow{2}{*}{21} & Retained &  0.893164 &  0.993925 &   0.991717 &  0.812427 \\
     &   & Churned &  0.160246 &  0.187477 &   0.089969 &  0.732117 \\
\cline{2-7}
     & \multirow{2}{*}{28} & Retained &  0.893381 &  0.994163 &   \textit{0.991941} &  0.812637 \\
     &   & Churned &  0.161846 &  0.194900 &   0.090869 &  \textit{0.739338} \\
\cline{2-7}
     & \multirow{2}{*}{35} & Retained &  0.898717 &  0.994195 &   0.991906 &  0.821534 \\
     &   & Churned &  0.167482 &  0.202993 &   0.094503 &  0.735337 \\
\cline{2-7}
     & \multirow{2}{*}{42} & Retained &  0.897824 &  0.994100 &   0.991815 &  0.820105 \\
     &   & Churned &  0.165886 &  \textbf{0.203295} &   0.093529 &  0.732800 \\
\cline{2-7}
     & \multirow{2}{*}{49} & Retained &  \textbf{0.900970} &  0.994093 &   0.991656 &  \textbf{0.825481} \\
     &   & Churned &  \textbf{0.168477} &  0.197516 &   \textbf{0.095300} &  0.725773 \\
\cline{2-7}
     & \multirow{2}{*}{56} & Retained &  0.897189 &  \textbf{0.994240} &   0.991878 &  0.819002 \\
